...
# remove columns contain NA
r3000_clean = r3000[, colSums(is.na(r3000)) == 0]

# save clean data
write.csv(r3000_clean, "data/r3000_clean.csv", row.names = T, col.names = T)
save(r3000_clean, file = "data/r3000_clean.rda")
